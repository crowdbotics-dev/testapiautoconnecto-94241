...
## Project Structure
    ...
    ├── testapiautoconnecto_94241  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_94241`
...
2. Clone this repo and `cd testapiautoconnecto_94241`
